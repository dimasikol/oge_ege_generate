...
from .views import show_quiz_oge,show_quiz_create,show_quiz_type, quiz_create,show_quiz_ege,quiz_result_oge
...
urlpatterns = [
    ...
    path('oge/quiz_result/', quiz_result_oge.StatisticOgeView.as_view(), name='quiz_result_oge'),
